...
init -1 python hide:
    ...
    config.window_title = u"Affection's Melody"
    ...
    style.window.background = Frame("gui/namebox.png", 0, 0)
    ...
    ## say_label is the name label if it is used
    ...
    style.default.font = "font/lucon.ttf"
...
init -1 python hide:
    ...
    #########################################
    ## The following snippet will automatically create definitions 
    ## for all the images in the 'game/' subfolders in your game directory.
init python:
    import os
    # load bg images
...
init python:
    ...
    build.executable_name = "Affection's Melody"
